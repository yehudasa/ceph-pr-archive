...
from ceph_volume_zfs.util import prepare as prepare_utils
...
class Prepare(object):
    ...
    def setup_device(self, device_type, device_name, tags):
        ...
        update the tags with the zfsvol_uuid and zfsvol_path which the incoming 
        tags will not have.
        """
    ...
    def safe_prepare(self, args):
        ...
        try:
            ...
            raise
        terminal.success("ceph-volume zfs prepare successful for: %s" % args.data)
    ...
    def prepare(self, args):
        ...
        if args.filestore:
            ...
            if not data_zfs:
                data_zfs = self.prepare_device(args.data, 'data', cluster_fsid, osd_fsid, self.osd_id)
