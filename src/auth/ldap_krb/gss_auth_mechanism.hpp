...
class GSSNameType
{
  public:
    ...
    */
    ...
    GSSNameType(const gss_name_t&);
    GSSNameType(const GSSDataBuffer&,
    ...
    operator gss_name_t*() { return &m_gss_type_name; }
    operator gss_name_t() { return m_gss_type_name; }
    operator const gss_name_t() const { return m_gss_type_name; }
...
class GSSSecCredential
{
  public:
    ...
    GSSSecCredential(gss_cred_id_t gss_credential) :
        m_gss_credential(gss_credential) { }
    GSSSecCredential(const GSSNameType&);
    ...
    */
    ...
    operator gss_cred_id_t() { return m_gss_credential; }
    operator gss_cred_id_t*() { return &m_gss_credential; }
...
class GSSSecurityCtx
{
  public:
    ...
    GSSSecurityCtx(const GSSDataBuffer&);
    ...
    class GSSSecurityCtxFlag
    {
      public:
        ...
        GSSSecurityCtxFlag(OM_uint32 gss_ctx_flags) :
...
class GSSDataBuffer
{
  public:
    ...
    GSSDataBuffer(const gss_buffer_desc&);
    GSSDataBuffer(size_t);
    GSSDataBuffer(const char*);
    GSSDataBuffer(const void*, size_t);
    GSSDataBuffer(const std::string&);
    ...
    operator const char*() const { return get_bytes(); }
    operator std::string() const { return get_string(); }

    operator const gss_buffer_desc_struct*() const
    { return &m_gss_buffer; }

    operator gss_buffer_desc_struct*()
    { return &m_gss_buffer; }
