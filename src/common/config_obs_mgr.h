...
public:
  typedef std::map<ConfigObs*, std::set<std::string>> rev_obs_map_t;
  ...
  void gather_all_observer_changes(config_gather_cb callback);
  template<class ConfigProxyT>
  void gather_changes(const std::set<std::string>& changes,
                      ConfigProxyT& proxy,
...
template<class ConfigObs>
void ObserverMgr<ConfigObs>::gather_all_observer_changes(config_gather_cb callback)
{
...
template<class ConfigObs>
template<class ConfigProxyT>
void ObserverMgr<ConfigObs>::gather_changes(const std::set<std::string>& changes,
                                            ConfigProxyT& proxy,
                                            config_gather_cb callback, std::ostream *oss)
{
